...
public abstract class AFile extends APsiWeaverJoinPoint {
    ...
    public List<? extends AClass> selectClass() {
        return select(plugin_psi_weaver.abstracts.joinpoints.AClass.class, SelectOp.DESCENDANTS);
    }
    ...
    public List<? extends AInterface> selectInterface() {
        return select(plugin_psi_weaver.abstracts.joinpoints.AInterface.class, SelectOp.DESCENDANTS);
    }
